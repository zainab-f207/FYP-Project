...
const AreaSafetyIntel = ({ areas }) => {
  ...
  useEffect(() => {
    if (!settingsLoading) {
      const dm = Math.min(24, Math.max(3, Math.round((systemSettings?.data_retention_days || 90) / 30)));
      setMonths(dm);
    }
  }, [settingsLoading, systemSettings?.data_retention_days]);

  // Compute for the dropdown "system default" option label
  const defaultMonths = Math.min(24, Math.max(3, Math.round((systemSettings?.data_retention_days || 90) / 30)));
        ...
        <div className={styles.cmdCard}>
          ...
          <div className={styles.cmdStatGrid}>
            <div className={styles.cmdStat}>
              ...
              <div className={styles.cmdStatLabel}>RF Accuracy</div>
            </div>
            <div className={styles.cmdStat}>
          ...
          <div className={styles.cmdBarSection}>
            <div className={styles.cmdBarRow}>
              <div className={styles.cmdBarLabel}>Random Forest Accuracy</div>
