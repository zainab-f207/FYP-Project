...
const apiService = {
  ...
  // Add these methods to the apiService object in apiService.js
  ...
  // In your apiService.js, update these functions:
  ...
  // Add this to your apiService in apiService.js
  ...
  // In apiService.js, update these functions:
  ...
  // In your apiService.js - Update the setup function
