"""Verify all 149 locations have geocoding coverage with NFC normalization."""
...
for loc in sorted(locations):
    ...
    if loc in geocode_mappings or loc_nfc in normalized_mappings:
        mapped += 1
    elif translate_structured(loc) or translate_structured(loc_nfc):
        translated += 1
    else:
...
if unmapped:
    ...
    print("ALL 149 LOCATIONS COVERED!")
