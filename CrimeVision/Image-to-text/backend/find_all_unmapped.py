"""Find all unmapped locations from fir_summary.txt and write to file."""
...
with open('unmapped_all.txt', 'w', encoding='utf-8') as f:
    for u in unmapped:
        f.write(u + '\n')
print("Written to unmapped_all.txt")
